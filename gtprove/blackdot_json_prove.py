...
import numpy as np
import h5py
json_file = '/media/w509/967E3C5E7E3C3977/1workspace/fix/fixations_val.json'
...
for j in range(0, len(imgs_path)):
    ...
    while True:
        ...
        if line:
            ...
            # lam = 640*480
            alp = 0.75
            area_1 = 0.8*math.exp((alp*s_rate))
...
# f.close()
f = h5py.File('/home/w509/1workspace/lee/360_fix_sort/gtprove/anothergt/true_true_true_gt/val_nums_0_8-0_75.h5', 'w')
f.create_dataset('labels', data=pros)
f.close()
