...
trainlabel =h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut-omron-new/h5_blackdot_nums/train_nums.h5','r')
trainfeature1 =h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/unisal_clone/feature_dut_2classi/train_unisal_roi_local.h5','r')
trainfeature2 =h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/unisal_clone/feature_dut_2classi/train_unisal_roi_global.h5','r')
train_xcenter = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut-omron-new/xycenter/xcenter_train_adjpg.h5', 'r')
train_ycenter = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut-omron-new/xycenter/ycenter_train_adjpg.h5', 'r')
...
f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut_new_select/h5_blackdot_nums/multiclassi_labels/train_multiclassi_0-5.h5', 'w')
# f.create_dataset('train', data=train_set)
f.create_dataset('labels', data=select_la)
f.close()

# f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut_new_select/train_unisal_roi_local.h5', 'w')
# # f.create_dataset('train', data=train_set)
# f.create_dataset('train', data=select_fea1)
# f.close()

f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut_new_select/train_unisal_roi_global.h5', 'w')
# f.create_dataset('train', data=train_set)
f.create_dataset('train', data=select_fea2)
f.close()

f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut_new_select/xycenter/xcenter_train_adjpg.h5', 'w')
# f.create_dataset('train', data=train_set)
f.create_dataset('xcenter', data=select_x)
f.close()

f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/dut_new_select/xycenter/ycenter_train_adjpg.h5', 'w')
# f.create_dataset('train', data=train_set)
