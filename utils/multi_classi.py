...
global ids
ids = 0
train_dataset = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/salicon_rand/h5_blcakdot_nums/train_nums.h5', 'r')

# train_set = np.array(train_dataset['train'][:])
train_labels = np.array(train_dataset['labels'][:])
train_labels = train_labels.tolist()
train_label=[]
path = r'/home/w509/1workspace/lee/360_fix_sort/boxtxt/salicon_rand/trainlocal/'
...
f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/salicon_rand/h5_blcakdot_nums/multiclassi_labels/train_multiclassi.h5', 'w')
