...
path = r'/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/box/coco_sitzmann_sim/train_box_local/'
path1 = r'/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/box/coco_sitzmann_sim/train_box_global/'
path2 = r'/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/box/coco_sitzmann_sim/train_box_sal_unisal/'
path3 = r'/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/box/coco_sitzmann_sim/train_box_sal_unisal/'
# path2 = r'/home/w509/1workspace/lee/Yet-Another-EfficientDet-Pytorch-master/salient360_img/box/val_box_gt/'
pathtxt1 = r'/home/w509/1workspace/lee/360_fix_sort/boxtxt/coco_sitzmann_sim/trainlocal/'
pathtxt2 = r'/home/w509/1workspace/lee/360_fix_sort/boxtxt/coco_sitzmann_sim/trainglobal/'
...
# imgs_path2 = os.listdir(path2)
# imgs_path2.sort(key=lambda x:str(x[:-4]))
img_local = '/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/randmbox/coco_sitzmann_sim/train_local'
img_global = '/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/randmbox/coco_sitzmann_sim/train_global'
img_sal = '/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/randmbox/coco_sitzmann_sim/train_sal'
img_flo = '/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/randmbox/coco_sitzmann_sim/train_gt'
save_txt ='/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/boxtxt/coco_sitzmann_sim/trainlocal'
...
gt_dataset = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/coco_sitzmann_sim/coco_sitzmann_sim/h5_blackdot_nums/coco_unisal_trainnums_new_0-1.h5', 'r')
...
#        gt
    ...
    # for t in range(0, 5):
    #     im = Image.open(path2 + '/' + img_t[t])
    #     im.save(img_gt + '/' + '{:06d}'.format(ids_gt)+'.jpg')
    #     ids_gt += 1
    #
    # for t in range(1, 6):
    #     im = Image.open(path2 + '/' + img_t[t])
...
f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/coco_sitzmann_sim/coco_sitzmann_sim_multi_rand/h5_blackdot_nums/coco_unisal_trainnums_new_0-1.h5', 'w')
