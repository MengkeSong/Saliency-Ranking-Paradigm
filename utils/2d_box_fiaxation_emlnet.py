...
path1 = '/home/w509/1workspace/lee/Yet-Another-EfficientDet-Pytorch-master/2dfixdataset/salmap_emlnet/res50_maps/'
...
imgs_path1.sort(key=lambda x:int(x[-16:-4]))
...
for j in range(0, len(imgs_path)):
    ...
    # img_nums +=4000
    img_name = imgs_path1[j]
    # img_name = '{:06d}'.format(img_nums)+'.jpg'
    # gt_name = img_txt[:-8]
    img_path = r'/home/w509/1workspace/lee/Yet-Another-EfficientDet-Pytorch-master/2dfixdataset/salmap_emlnet/res50_maps/' + '%s' % (img_name)
    ...
    while True:
        ...
        if line:
            ...
            save_path = '/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/box/salicon/emlnet/val/'
