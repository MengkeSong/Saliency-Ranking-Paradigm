...
pathtxt1 = r'/home/w509/1workspace/lee/Yet-Another-EfficientDet-Pytorch-master/boxtxt/vallocal/'
pathtxt2 = r'/home/w509/1workspace/lee/Yet-Another-EfficientDet-Pytorch-master/boxtxt/valglobal/'

txtpath1 = os.listdir(pathtxt1)
txtpath2 = os.listdir(pathtxt2)
txtpath1.sort(key=lambda x:str(x[:-8]))
txtpath2.sort(key=lambda x:str(x[:-8]))
...
gt_dataset = h5py.File('/home/w509/1workspace/lee/2dfix_classi/feature_salcon/h5_blackdot_nums/valnums_fixs.h5', 'r')
...
f = h5py.File('/media/w509/967E3C5E7E3C3977/1workspace/code/360_fix_sort/feature/salicon_multi_rand_5/h5_blackdot_nums/val_nums_fixs.h5', 'w')
